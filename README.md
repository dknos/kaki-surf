...
The native suite passes **323/323 tests** and the syntax gate checks **41 JavaScript modules**. New invariants cover the persistent Auto/Full/Mobile setting, touch-first Mobile resolution, sustained-frame-pressure adaptation, presentation-only density scaling, analog touch magnitude and multitouch independence, fullscreen-before-landscape-lock ordering, portrait gating and rotation resume, canonical board/path agreement, mirrored wakes, no front-facing wake, carried drop/climb energy, cutback timing, full-face traversal, shared Simple/Advanced aerial rotation and Turbo, qualified aerial tiers, the perfect-landing/scoop/preload/Turbo rebound chain, coherent stage-camera projection, exact stage/panorama ocean anchoring, presentation-free physics and spawning, camera-relative spawns, ocean-anchored sharks and lower-atmosphere traffic, contextual mount dismounts, whale water/collision anchors, SimplyTerrell's cosmetic-only character contract, the tangent-aligned Turbo contact ribbon, and the visible package-version contract. The local gallery contains **143 deterministic 1280 x 720 captures**, including re-entry in all three conditions, while `docs/images/qa-world-camera` records real-input launch, apex, descent, touchdown, and post-landing frame sequences in both travel directions and Reduced Motion.

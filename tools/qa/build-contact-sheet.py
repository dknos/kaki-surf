...
SCENES = (
    ...
    ("heroOpen-twilightGlass", "Twilight hero barrel / open"),
    ("heroDeep-twilightGlass", "Twilight hero barrel / deep"),
    ("heroMax-twilightGlass", "Twilight hero barrel / maximum"),
    ("heroCollapse-twilightGlass", "Twilight hero barrel / collapse"),

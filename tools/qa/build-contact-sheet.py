...
SCENES = (
    ...
    ("menu-kakiLand", "Kaki-Land / selected condition card"),
    ("results-kakiLand", "Kaki-Land / Relay results"),
    ...
    ("cutback-kakiLand", "Kaki-Land / committed cutback"),
    ("turbo-kakiLand", "Kaki-Land / Turbo signal"),
    ("smallAir-kakiLand", "Kaki-Land / small aerial"),
    ("mediumAir-kakiLand", "Kaki-Land / medium cloud aerial"),
    ("hugeAir-kakiLand", "Kaki-Land / huge aerial"),
    ("aerialCloud-kakiLand", "Kaki-Land / high-air cloud network"),
    ("aerialUpper-kakiLand", "Kaki-Land / upper tiled starfield"),
    ("aerialSpace-kakiLand", "Kaki-Land / The Last Relay reveal"),
    ("lastRelay-kakiLand", "The Last Relay / notice deform settle"),
    ("relayStart-kakiLand", "Webring Relay / three links open"),
    ("relayStartLeft-kakiLand", "Webring Relay / left-travel links"),
    ("relayGate1-kakiLand", "Webring Relay / first drawing received"),
    ("relayGate2-kakiLand", "Webring Relay / second drawing received"),
    ("relayGate3-kakiLand", "Webring Relay / ring closed"),
    ("relayComplete-kakiLand", "Webring Relay / mural and Approval"),
    ("dolphin-kakiLand", "Kaki-Land / dolphin interaction"),
    ("shark-kakiLand", "Kaki-Land / shark near miss"),
    ("wipeout-kakiLand", "Kaki-Land / wipeout"),
    ("recovery-kakiLand", "Kaki-Land / damp recovery"),
    ("lateEndless-kakiLand", "Kaki-Land / late Endless convergence"),
    ("scoreFinal-kakiLand", "Kaki-Land / Score Attack final stretch"),
    ("relayHighContrast-kakiLand", "Kaki-Land Relay / High Contrast"),
    ("relayReduced-kakiLand", "Kaki-Land Relay / Reduced Motion"),
    ("relayMobile-kakiLand", "Kaki-Land Relay / forced Mobile quality"),
    ("highContrast-kakiLand", "Kaki-Land residents / High Contrast"),
    ("reducedMotion-kakiLand", "Kaki-Land residents / Reduced Motion"),
    ("mobile-kakiLand", "Kaki-Land residents / forced Mobile quality"),
    ...
    ("aerialCloud-goldenCoast", "Golden Coast / cloud layer"),
    ("aerialUpper-goldenCoast", "Golden Coast / upper atmosphere"),
    ("aerialSpace-goldenCoast", "Golden Coast / Kaki Space"),
    ("aerialReentry-goldenCoast", "Golden Coast / re-entry guide"),
    ("aerialCoast-twilightGlass", "Twilight / coastal sky"),
    ("aerialCloud-twilightGlass", "Twilight / cloud layer"),
    ("aerialUpper-twilightGlass", "Twilight / upper atmosphere"),
    ("aerialSpace-twilightGlass", "Twilight / Kaki Space"),
    ("aerialReentry-twilightGlass", "Twilight / atmospheric re-entry"),
    ("aerialCoast-stormbreak", "Stormbreak / storm interior"),
    ("aerialCloud-stormbreak", "Stormbreak / thunderheads"),
    ("aerialUpper-stormbreak", "Stormbreak / upper atmosphere"),
    ("aerialSpace-stormbreak", "Stormbreak / stars above storm"),
    ("aerialReentry-stormbreak", "Stormbreak / atmospheric re-entry"),
    ...
    ("kakiLand", "Kaki-Land environment"),
    ...
    ("foamPuff-kakiLand", "Foam Puff / Kaki-Land"),
    ...
    ("mangoFish-kakiLand", "Mango Fish / Kaki-Land"),
    ...
    ("moonLog-kakiLand", "Moon Log / Kaki-Land"),
)

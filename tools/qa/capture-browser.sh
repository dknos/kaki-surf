...
scenes=(
  coreSurfLab menu results settingsSimple settingsAdvanced simpleKeyboard simpleGamepad neutral leftTravel rightTravel
  downhillRight downhillLeft uphill reversal downhill curlEarly curlFolding curlImpact curlDanger

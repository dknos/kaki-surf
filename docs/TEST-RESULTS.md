...
- Four-tier launch qualification, earned Turbo-only space access, nonlinear canonical aerial altitude, descent anticipation, fixed-stage/rider-only coordinate-space ownership, stable masked panorama shelves with hysteresis and rate limits, signed horizontal panorama travel, camera-matched coast restoration through advanced-break cutouts, zone milestones, altitude-filtered surf/wind, and fixed-step orbital ascent/descent continuity.

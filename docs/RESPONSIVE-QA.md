...
These focused captures are rendering/framing evidence, not substitutes for the touch-lifecycle scenes. At all three sizes, the complete 16:9 playfield remains visible: the coherent break stays joined to the face, the tube rider is not clipped, the large-air camera reveals sky without separating the horizon, and the landing guide remains inside the Canvas. The portrait fixtures also document the deliberate centered letterbox above and below the fixed logical playfield.

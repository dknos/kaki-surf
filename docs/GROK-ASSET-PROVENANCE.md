...
- The complete earlier Twilight barrel remains the coherent secondary fallback for High Contrast or a missing primary atlas. The active normal-palette silhouette is the final coherent-break atlas welded to simulation-owned face volume, tube shadow, trailing churn, and collision contact.
